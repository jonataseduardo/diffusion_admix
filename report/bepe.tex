...
% DM: É preciso falar em load e efficacy of selection sob um modelo neutro, na
% medida em que, por definição, numa simulação neutra, não há load pois todas
% as mutações são load por terem s=0? Há algo aqui que soa impreciso.
% JC: Tried to adjust 
...
% DM: Porque "between large"? E between large and small?
% JC: por que a aproximação de diffusão só é boa para populaçoes com N grande 
